...
public class PhotonUI : MonoBehaviour
{
    ...
    public void ConnectedToServer()
    {
        ...
        m_CreateRoomButton.onClick.AddListener(() =>
        {
            ...
            int playersMaxCount = 7;

            // int roomCount = roomsUI == null ? 0 : roomsUI.Length;
            OnCreateRoomButton?.Invoke(m_PlayerNameText.text + "s Room", playersMaxCount);
        });
    }
    ...
    public void CreatedRoom(int maxPlayers)
    {
        ...
        m_AddBotButton.gameObject.SetActive(false);
    ...
    {
        m_ConnectedPlayersText.text = "Waiting for other players...";// + playersCount + " of " + maxPlayers;
